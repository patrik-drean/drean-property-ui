...
export const EvaluationSection: React.FC<EvaluationSectionProps> = ({
  ...
  // Mock rent estimate (typically ~1% of ARV per month for rentals)
  const estimatedRent = Math.round(estimatedArv * 0.008);
      ...
      <Stack spacing={2}>
        ...
        <Box>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Tooltip title="Edit Rent (TASK-082)">
              <IconButton
                size="small"
                onClick={onEditRent}
                sx={{
          ...
          <ConfidenceBadge confidence={78} source="ai" />
        </Box>
